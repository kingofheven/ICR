...
class FewShotDatasetReader(torch.utils.data.Dataset):
    ...
    def get_length(self, text):
        tokenized_example = self.tokenizer.encode_plus(text,truncation=True,return_tensors='pt')
    ...
    def text_to_instance(self, entry: Dict[str, Any],index=-1):
        ...
        tokenized_example = self.tokenizer.encode_plus(enc_text,truncation=True,return_tensors='pt',add_special_tokens=False)
